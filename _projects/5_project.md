					...
					<div id="main"> 
						<div class="inner">
							...
							<p><h9>This was a serialized short story I sent by email to participants of Dinacon 2019. (THe Digital Naturalism Conference). <details>
								...
								<p>"YOU might have SAVED OUR WHOLE TIMELINE?" yells Tess. The whole crowd begins screaming at him. It’s as if all their anger, all their confusion from the last three years, is finally able to be released now. The man tries to keep up a smile at first, tries to calm them down, but when they start surrounding him, he gets a panicked look on his face and suddenly, loudly, claps his hands.</p>
								<p>*</p>
					...
					<footer id="footer">
						<div class="inner">
							...
							<section>
								<h2>Follow</h2>
								<ul class="icons">
									<li><a href="https://twitter.com/Mary_T_Miller" class="icon style2 fa-twitter"><span class="label">Twitter</span></a></li>
									<li><a href="https://www.facebook.com/dezmediah/" class="icon style2 fa-facebook"><span class="label">Facebook</span></a></li>
									<li><a href="https://www.instagram.com/dezmediah/" class="icon style2 fa-instagram"><span class="label">Instagram</span></a></li>
									<li><a href="#" class="icon style2 fa-github"><span class="label">GitHub</span></a></li>
									<li><a href="Contact.html" class="icon style2 fa-envelope-o"><span class="label">Email</span></a></li>
								</ul>
							</section>
							<ul class="copyright">
